    ...
    <div class="col-lg-6 order-1 order-lg-2 mb-2">
        <div class="card">
            <div class="card-body py-5">
                ...
                <form action="{{ route('exam-sessions.result', [
                    'exam_session' => $examSession,
                    'participant_exam_result' => $participantExamResult
                ...
                <div class="text-center py-4">
                    <x-button color="dark" class="btn-lg" as="a" :href="route('exam-sessions.results', $examSession)">
