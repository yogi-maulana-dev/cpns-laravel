...
<div class="row">
    <div class="col">
        <form action="{{ route('exam-sessions.store') }}" method="post" novalidate>
            @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-4">
                            <div class="mb-3">
                                ...
                                <x-forms.input type="number" name="time" :value="old('time')" min="0" step="5" />
                            </div>
                            <div class="mb-3">
                                ...
                                <x-forms.input class="flatpickr-custom" data-enable-time="true" data-alt-onput="true"
                                    data-alt-format="d F Y H:i" name="start_at" :value="old('start_at')" />
                            </div>
                            <div class="mb-3">
                                <x-forms.label id="end_at">Tanggal & Waktu Berakhir</x-forms.label>
                                <x-forms.input class="flatpickr-custom" data-enable-time="true" data-alt-onput="true"
                                    data-alt-format="d F Y H:i" name="end_at" :value="old('end_at')" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body py-4">
                            <div class="mb-3">
                                ...
                                <x-forms.tom-select name="order_of_question">
                                    ...
                                    <option value="{{ $id }}" @selected(old('order_of_question')==$id)>{{ $text }}
                                    </option>
                                    @endforeach
                                </x-forms.tom-select>
                            </div>
                            <div class="mb-3">
                                ...
                                <x-forms.tom-select name="result_display_status">
                                    ...
                                    <option value="{{ $id }}" @selected(old('result_display_status')==$id)>{{ $text }}
                                    </option>
                                    @endforeach
                                </x-forms.tom-select>
                            </div>
            ...
            <x-action-buttons :index="route('exam-sessions.index')" />
