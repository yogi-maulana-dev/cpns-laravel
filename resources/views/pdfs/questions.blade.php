            ...
            <tr class="align-top">
                ...
                <td>
                    ...
                    <div class="image-and-text">
                        <img class="question-image" src="{{ public_path('storage/' . $question->question_image) }}"
                            alt="Gambar Soal" />
                    ...
                    <ul class="question-answers align-top">
                        ...
                        <li class="align-top">
                            ...
                            <div class="answer-image-and-text">
                                <img class="answer-image" src="{{ public_path('storage/' . $answer->answer_image) }}"
                                    alt="Gambar Jawaban" />
                    ...
                    <div class="discussion">
                        ...
                        <div class="discussion-image-and-text">
                            <img class="discussion-image"
                                src="{{ public_path('storage/' . $question->discussion_image) }}"
